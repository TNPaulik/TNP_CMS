		<div class="box-header">
			<span class="title">Element bearbeiten</span>
		</div>
		<div class="box-content">
			<form class="fill-up" enctype="multipart/form-data" method="post">
				<div class="row">
					<div class="col-lg-12">
						...
						<ul class="padded separate-sections">
							...
							<li class="input">
								<label>Name:</label>
								<input value="<?= $this->element->name ?>" name="name" type="text" />
							</li>
							
							<li class="input">
								<label>Type</label>
								<input class="type" name="type" type="text" readonly="readonly" value="<?= $this->element->type ?>" />
								</select>
							...
							<li class="input">
								...
								<input class="foreigner" name="foreign_id" type="text" readonly="readonly" value="<?= $this->element->foreign_id ?>" />
								<div class="menu">
									<ul>
										<li>
											<a href="">Bilder</a>
				...
				<div class="form-actions">
					...
					<button type="submit" class="btn btn-green"><i class=" icon-pencil"></i>&nbsp;&nbsp;&nbsp;Element speichern</button>
				</div>
			</form>
